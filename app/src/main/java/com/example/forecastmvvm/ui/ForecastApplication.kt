...
import com.example.forecastmvvm.ui.ui.settings.weather.future.detail.FutureDetailWeatherViewModelFactory
import com.example.forecastmvvm.ui.ui.settings.weather.future.list.FutureListWeatherViewModelFactory
...
class ForecastApplication: Application(), KodeinAware {
    override val kodein = Kodein.lazy {
        ...
        bind<ForecastRepository>() with singleton { ForecastRepositoryImpl(
